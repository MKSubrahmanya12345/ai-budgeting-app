    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 w-12 h-12 sm:w-14 sm:h-14 bg-cyan-600 hover:bg-cyan-500 rounded-full flex items-center justify-center shadow-lg shadow-cyan-900/50 transition-all hover:scale-105 active:scale-95 z-[9999] animate-bounce group"
        >
      ...
      {/* Chat Popover */}
      {isOpen && (
        <div className="fixed inset-x-4 bottom-4 top-20 sm:inset-auto sm:bottom-6 sm:right-6 sm:w-[400px] sm:h-[550px] bg-slate-950 rounded-3xl border border-slate-800 shadow-2xl flex flex-col overflow-hidden z-[9999] animate-in slide-in-from-bottom-5 fade-in duration-300">
